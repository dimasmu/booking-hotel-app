...
const Footer = () => {
    return (
        <footer className='bg-gray-900 '>
            <div className='max-w-screen mx-auto px-4 w-full py-20 md:py-16'>
                <div className='grid md:grid-cols-3 gap-7'>
                    <div>
                        ...
                        <p className='text-gray-400'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate expedita dolores natus in saepe consequuntur?
                        </p>
                    </div>
                    <div>
                        <div className='flex gap-20'>
                            <div className='flex-1 md:flex-none'>
                                ...
                                <ul className='list-item space-y-5 text-gray-400'>
                                    ...
                                    <li>
                                        <Link href="/room" className='hover:text-orange-400 transition duration-300'>Rooms</Link>
                                    </li>
                                    <li>
                            ...
                            <div className='flex-1 md:flex-none'>
                                ...
                                <ul className='list-item space-y-5 text-gray-400'>
                                    <li>
                                        <Link href="#" className='hover:text-orange-400 transition duration-300'>Legal</Link>
                                    </li>
                                    <li>
                                        <Link href="#" className='hover:text-orange-400 transition duration-300'>Term & Condition</Link>
                                    </li>
                                    <li>
                                        <Link href="#" className='hover:text-orange-400 transition duration-300'>Payment Method</Link>
                                    </li>
                                    <li>

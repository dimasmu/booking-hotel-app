  ...
  return (
    <div className="bg-white shadow-lg rounded-sm transition duration-100 hover:shadow-sm">
      <div className="h-[260px] w-auto rounded-t-sm relative">
        <Image src="/hero.jpg" alt="room image" width={384} height={256} className="w-full h-full object-cover rounded-t-sm" />
      </div>
      <div className="p-8">
        ...
        <h4 className="text-2xl mb-7">
          <span className="font-semibold text-gray-600">Rp 21000</span>
